...
**Umgebung:** frische Compose-Umgebung (Projekt drill-staging) als Staging-Ersatz gemäß A-107; Repository auf Volume `drill-offsite-20260925155222` als Stellvertreter des Offsite-Speichers.
**Zeitpunkt:** 2026-09-25T15:53:27Z UTC; Host: pulse-pc3; Images: lokal gebaut.

| Messgröße | Wert | Grenze | Ergebnis |
|---|---|---|---|
| RTO (Wiederherstellung bis Datenbank bereit) | 15 s | 14400 s | ok |
...
stanza: main
    ...
    db (current)
        ...
        full backup: 20260925-155248F
            timestamp start/stop: 2026-09-25 15:52:48+00 / 2026-09-25 15:52:49+00
